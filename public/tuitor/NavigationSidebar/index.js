    ...
    <ul class="list-group wd-unique">
      ...
      <li class="list-group-item wd-main-menu">
        <div class="row">
          ...
          <div class="d-none d-xxl-block d-xl-block col-4 col-sm-0 col-md-0 col-lg-0 col-xl-4 col-xxl-4"><a href="../HomeScreen/explore.html"">Home</a></div>
        </div>
      </li>
      <li class="list-group-item wd-main-menu">
        <div class="row">
          <div class="col-2 col-sm-2 col-md-2 col-lg-2 col-xl-2 col-xxl-2"><i class="fa-solid fa-hashtag"></i></div>
          <div class="d-none d-xxl-block d-xl-block col-4 col-sm-0 col-md-0 col-lg-0 col-xl-4 col-xxl-4"><a href="../explore/explore.html">Explore</a></div>
        </div>
      </li>
      <li class="list-group-item wd-main-menu">
        <div class="row">
